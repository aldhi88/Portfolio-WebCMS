...
class SlideshowController extends Controller
{
    public function index()
    {
        ...
        return view('modules.slideshow.index',compact('data'));
    }
            ...
            ->addColumn('action',function($data){
                ...
                <div class="media my-1" >
                    ...
                    <div class="media-body">
                        ...
                        -<a class="text-primary fs-13" href="'.route("slideshows.edit",$data->id).'" data-id="'.$data->id.'"> Edit</a>
                    </div>
                </div>
                ';
                return $el;
    ...
    public function create()
    {
        ...
        return view('modules.slideshow.create',compact('data'));
    }
    ...
    public function edit($id)
    {
        ...
        $data['maxSize'] = Setting::where('key','max_file_upload')->first()->getAttribute('value');
        return view('modules.slideshow.edit',compact('data','edit'));
    }
