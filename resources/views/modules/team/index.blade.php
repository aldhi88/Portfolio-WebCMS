@extends('components.layout.main',['title' => 'Data Asisten'])
@section('css')
@include('components.dtable.style')
@endsection
@section('js')
@include('components.dtable.script')
    @include('modules.team.include.index_js')
...
<div class="row">
    <div class="col">
        @include('components.content.page_title',[
            'title' => 'Data Asisten',
            'right' => '<a href="'.route('teams.create').'" class="btn btn-outline-primary waves-effect waves-light btn-sm">Tambah Asisten Baru</a>'
        ])
