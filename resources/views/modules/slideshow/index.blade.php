@extends('components.layout.main',['title' => 'Data Slideshow'])
@section('css')
@include('components.dtable.style')
@endsection
@section('js')
@include('components.dtable.script')
    @include('modules.slideshow.include.index_js')
...
<div class="row">
    <div class="col">
        @include('components.content.page_title',[
            ...
            'right' => '<a href="'.route('slideshows.create').'" class="btn btn-outline-primary waves-effect waves-light btn-sm">Tambah Slideshow Baru</a>'
        ])
...
@include('modules.slideshow.delete')
@endsection