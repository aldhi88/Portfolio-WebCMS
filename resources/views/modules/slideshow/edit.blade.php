@extends('components.layout.main',['title' => 'Edit Data Slideshow'])
@section('css')
@endsection
@section('js')
<script src="{{asset('assets/libs/tinymce/tinymce.min.js')}}"></script>
    @include('modules.slideshow.include.edit_js')
@endsection
...
<div class="row">
    <div class="col">
        @include('components.content.page_title',[
            ...
            'right' => '
                <a href="'.route('slideshows.index').'" class="btn btn-outline-primary waves-effect waves-light btn-sm">Semua Slideshow</a>
                <a href="'.route('slideshows.create').'" class="btn btn-outline-primary waves-effect waves-light btn-sm">Tambah Slideshow Baru</a>
            '
        ])
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <input type="text" value="{{$edit['title']}}" name="title" class="form-control form-control-lg" placeholder="Judul Slide">
